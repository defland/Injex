...
git clone https://github.com/InjexCore/injex
```
...
```bash
    ...
    From https://github.com/InjexCore/injex
...
[injex/gitian.sigs](https://github.com/InjexCore/gitian.sigs/) repository, or if that's not possible to create a pull
request.

...
Injex Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 12455.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 12454 for connections and services them.
...
However, in open source software such as Injex Core, where everyone uses
...
pay attention to for reviewers of Injex Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Injex Core uses tinyformat, which is type safe. Leave them out to avoid confusion

...
Only requiring some minor changes is injex.cpp.
...
Changes to injex.cpp
----------------------
injex.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

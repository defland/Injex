...
#define BOOST_TEST_MODULE Injex Test Suite

#include "test_injex.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_injex_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

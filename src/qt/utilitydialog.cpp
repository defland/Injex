    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Injex Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Injex Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  injex-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Injex in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 INJ, 0.1 INJ, 1 INJ and 10 INJ -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://InjexCore.atlassian.net/wiki/display/DOC/PrivateSend\">https://InjexCore.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Injex Core is shutting down...") + "<br /><br />" +

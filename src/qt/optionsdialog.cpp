    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("INJ-light"), QVariant("light"));
    ui->theme->addItem(QString("INJ-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("INJ-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("INJ-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("INJ-traditional"), QVariant("trad"));

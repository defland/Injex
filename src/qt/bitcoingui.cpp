    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Injex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Injex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and injex: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Injex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Injex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Injex Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Injex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Injex addresses"));
    ...
    openAction->setStatusTip(tr("Open a injex: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Injex Core help message to get a list with possible Injex Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Injex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Injex network", "", count));
    } else {
...
{
    QString strTitle = tr("Injex Core"); // default title

...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "InjexNetwork") type = InjexNetwork;
    if(strType == "InjexNetworkVariable") type = InjexNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == InjexNetwork) s = "InjexNetwork";
    if(type == InjexNetworkVariable) s = "InjexNetworkVariable";

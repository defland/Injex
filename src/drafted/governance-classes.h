 ...
 *
 *   // network
 *   CInjexNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.injex.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CInjexNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: InjexNetwork
// //   -- signature requirements : Key1(User)
// class CInjexNetworkVariable : public CGovernanceObject
// {
// private:

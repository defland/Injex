...
This issue tracker is only for technical issues related to Injex Core.
General Injex questions and/or support requests and are best directed to the [Injex Discord](http://discord.injex.network).
...
### What version of Injex Core are you using?
